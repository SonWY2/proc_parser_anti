...
class HeaderClassifier:
    ...
    def _determine_type(
        self, has_stp: bool, has_typedef: bool, has_macros: bool, has_functions: bool
    ) -> HeaderType:
        """타입 결정 로직"""
    ...
    def classify_file(self, file_path: str) -> HeaderInfo:
        ...
        if self._is_system_header(file_path):
            info = HeaderInfo(path=file_path, header_type=HeaderType.SYSTEM_HEADER)
        ...
        try:
            ...
            info = HeaderInfo(path=file_path, header_type=HeaderType.UNKNOWN)
            return info
    ...
    def classify_from_cpg(self, cpg) -> Dict[HeaderType, List[HeaderInfo]]:
        ...
        """
        try:
            node_type_module = importlib.import_module("analysis.cpg.models")
        except ImportError:
            node_type_module = importlib.import_module("CPG.models")
        NodeType = node_type_module.NodeType
