...
class CPGBuilder:
    ...
    def build_from_file(self, file_path: str) -> CPG:
        """
        단일 파일에서 CPG를 생성합니다.
        ...
        return self.build_from_source(source_code, file_path)
    
    def build_from_source(self, source_code: str, file_path: str = "<unknown>") -> CPG:
        """
        소스 코드에서 CPG를 생성합니다.
